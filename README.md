...
Coleccion de workflows n8n de ejemplo, listos para importar. Cada workflow incluye documentacion, diagrama de flujo y variables necesarias.
...
**Nodos**: Schedule Trigger, HTTP Request (con retry), IF, Telegram, Set

[Ver documentacion](workflows/01-api-health-monitor.md)
...
[Ver documentacion](workflows/02-data-pipeline-csv.md)
...
[Ver documentacion](workflows/03-notification-router.md)

## Como importar

1. Ir a n8n → Menu → Import from File
2. Seleccionar el archivo `.json` del workflow deseado
3. Configurar las credenciales y variables de entorno indicadas en la documentacion
